...
//           role: "system",
//           content:
//             "You are a creative thumbnail designer. Rewrite prompts clearly for an image generator.",
//         },
//         {
//           role: "user",
//           content: `User answered: ${answers}. 
//           Generate a short but powerful thumbnail background idea.`,
//         },
//       ],
//     });
...
//     // Step 2: Generate or Edit thumbnail
//     let imageGen;
//     if (file && buffer) {
//       imageGen = await openai.images.edit({
//         model: "gpt-image-1",
...
//     return NextResponse.json({
//       prompt: rewrittenPrompt,
//       thumbnail: imageGen.data[0].url,
//     });
//   } catch (err) {
//     console.error("Thumbnail generation error:", err.response?.data || err.message || err);
//     return NextResponse.json(
//       { error: "Failed to generate thumbnail", details: err.response?.data || err.message },
//       { status: 500 }
//     );
//   }
// }
